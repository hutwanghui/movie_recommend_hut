let storage = {
  apiKey: 'c2f8fe5b024fded37dbb4202e5657ebd',
  sessionId: localStorage.getItem('session_id') || null,
  userId: localStorage.getItem('user_id') || null,
  pageTitlePostfix: ' — ' + document.title,
  baseUrl_2: '//localhost:8960/kkcms-gate',
  listTypes: [
    {
    ...
    },
    {
      ...
      title: 'Recommend Movies From Your frinends',
      query: 'userRecomend',
      isCategory: false
    },{
      title: 'Recommend Movies From System',
      query: 'modelRecommend',
      isCategory: false
    }
  ],
  categories: {},
