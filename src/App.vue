...
<script>
  ...
  import MoviePopup from './views/MoviePopup'
  ...
  export default {
    ...
    created() {
      ...
      this.$root.eventHub.$on('openMoviePopup', this.openMoviePopup)
      this.$root.eventHub.$on('setSearchQuery', this.setSearchQuery)
      this.$root.eventHub.$on('requestToken', this.requestToken)
      this.$root.eventHub.$on('setUserStatus', this.setUserStatus)
